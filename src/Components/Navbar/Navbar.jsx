            ...
            <nav className='container mx-auto py-4 flex items-center justify-between px-3 lg:px-0  '>
                ...
                <div className='flex  items-center gap-5 lg:gap-10'>
                    <ul className='space-x-3 font-bold hidden md:block'>
                        ...
                        {
                            user && <NavLink className='p-1' to='/dashboard'>Dashboard</NavLink>
                        }
                    </ul>
                    ...
                    <div className='flex items-center justify-center'>
...

                        {
                            user ? <div className='  relative inline-block group '>
                                ...
                                <Link to='/login' className='py-3 px-8 rounded   border border-secondary  hover:bg-[#15534c] hover:text-primary-content  '>
                                    Login
                                </Link>
                                <Link to='/register' >
                                    <button className='py-3 px-8 rounded bg-secondary font-bold  text-secondary-content border-none hover:bg-secondary/80 hidden lg:block'>
                                        Register
                                    </button>
                                </Link>
                ...
                <div className={`absolute sm:hidden  z-50 bg-base-100 h-[1500px] w-[65%] top-0 transition-all duration-500 ${toggle ? 'left-0' : '-left-[500px]'}`} >
                    ...
                    <div className=' text-base-content'>
                        <ul className='flex flex-col text-center items-center gap-2 '>
                            ...
                            <NavLink onClick={() => setToggle(!toggle)} to='/contact' className='hover:text-primary font-semibold p-2  border-base-300 border-x-0 w-full border-t-0  border-b-1'>Contact</NavLink>
                            <NavLink onClick={() => setToggle(!toggle)} to='/about' className='hover:text-primary font-semibold p-2  border-base-300 border-x-0 border-t-0 w-full  border-b-1'>About Us</NavLink>
                            {
                                user && <NavLink onClick={() => setToggle(!toggle)} to='/dashboard' className='hover:text-primary font-semibold p-2  border-base-300 border-x-0 border-t-0 w-full  border-b-1'>Dashboard</NavLink>
