                ...
                <SwiperSlide>
                    <Fade>
                        <div
                            ...
                            className='h-[80vh]  bg-base-200 flex flex-col items-start justify-center gap-5  lg:pl-10  p-4'
                        >
                            <div data-aos="fade-up" className='space-y-3 text-white w-full max-w-xl'>
                ...
                <SwiperSlide>
                    <Fade>
                        <div style={{
                            ...
                            backgroundPosition: "center",
                            backgroundSize: "cover",
                        }} className='h-[80vh]  flex md:flex-row items-center justify-center md:pt-2'>
                ...
                <SwiperSlide>
                    <Fade>
                        <div
                            ...
                            className='h-[80vh]  lg:bg-right flex flex-col items-start justify-center gap-5 p-4   md:pl-10 text-white'
                        >
                            <div data-aos="fade-up" className='space-y-3 w-full text-left md:max-w-3xl'>
                                <h1 className='text-2xl sm:text-3xl lg:text-6xl font-bold'>
